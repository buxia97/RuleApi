...
public class TypechoSpaceServiceImpl implements TypechoSpaceService {
	...
	@Override
	public PageList<TypechoSpace> selectPage(TypechoSpace typechoSpace, Integer offset, Integer pageSize) {
		...
		List<TypechoSpace> list = dao.selectPage(typechoSpace, page, pageSize);
