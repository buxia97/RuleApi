...
public interface ChatMsgService {
     ...
     * [分页条件查询]
     **/
    PageList<TypechoChatMsg> selectPage (TypechoChatMsg typechoChatMsg, Integer page, Integer pageSize,String searchKey);

    /**
     * [总量查询]
     **/
    int total(TypechoChatMsg typechoChatMsg,String searchKey);
}
